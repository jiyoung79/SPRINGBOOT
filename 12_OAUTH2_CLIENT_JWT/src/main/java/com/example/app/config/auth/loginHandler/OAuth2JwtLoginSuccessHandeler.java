...
@Slf4j
public class OAuth2JwtLoginSuccessHandeler implements AuthenticationSuccessHandler {

    JwtTokenProvider jwtTokenProvider;

    public OAuth2JwtLoginSuccessHandeler(JwtTokenProvider jwtTokenProvider) {
